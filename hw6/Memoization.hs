...
fibBooster :: (Int -> TableBased c a Int) -> (Int -> TableBased c a Int)
fibBooster otherFib = \n -> case (n <= 1) of
                            True -> lift0 1
                            False -> lift2 (\x -> \y -> x + y) (otherFib (n-1)) (otherFib (n-2))

fastFib :: Int -> Int
fastFib = memoFix fibBooster
